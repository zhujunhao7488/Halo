...
class hash_api {
 public:
  ...
  hash_api(size_t sz = 1024 * 16) {
    ...
    std::string index_pool_name = "/mnt/pmem/pmem.data";
...
class hash_api {
 public:
  ...
  hash_api() {
    ...
    std::string index_pool_name = "/mnt/pmem/viper";
...
#ifdef PMDK_HALO
#include "Halo_PMDK/Halo.hpp"
class hash_api {
 public:
  std::string hash_name() { return ""; };
  ~hash_api() {}
  bool find(size_t key, Pair_t *p) { return true; }
  bool find(size_t key, viper::Viper<uint64_t, VALUE_T>::Client &c,
            VALUE_T *v) {
    return true;
  }
  bool insert(size_t key, size_t value_len, char *value, int tid, int *r) {
    return true;
  }
  bool insert(size_t key, size_t value_len, char *value,
              viper::Viper<uint64_t, VALUE_T>::Client &c) {
    return true;
  }
  viper::Viper<uint64_t, VALUE_T>::Client get_client() {}
  bool erase(size_t key, int tid) { return true; }
  bool erase(size_t key, viper::Viper<uint64_t, VALUE_T>::Client &c) {
    return true;
  }
  void load_factor(viper::Viper<uint64_t, VALUE_T>::Client &c){};
  void wait(){};
  void load_factor(){};
  void thread_ini(int id){};
};
...
class hash_api {
 public:
  ...
  ~hash_api() {}
  bool find(size_t key, Pair_t *p) { return true; }
  bool find(size_t key, viper::Viper<string, string>::Client &c, string *v) {
    return true;
  }
  bool insert(size_t key, size_t value_len, char *value, int tid, int *r) {
    return true;
  ...
  bool insert(size_t key, size_t value_len, char *value,
              viper::Viper<string, string>::Client &c) {
    return true;
  }
  viper::Viper<string, string>::Client get_client() {}
  bool erase(size_t key, int tid) { return true; }
  bool erase(size_t key, viper::Viper<string, string>::Client &c) {
    return true;
  }
  void load_factor(viper::Viper<string, string>::Client &c){};
  void wait(){};
  void load_factor(){};
  void thread_ini(int id){};
};
